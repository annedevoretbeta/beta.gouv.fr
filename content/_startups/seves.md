...
SÈVES est un outil à destination de l’ensemble de la DGAL et de ses services déconcentrés, il permet la gestion partagée des événement sanitaires : sécurité sanitaires des aliments, santé des végétaux et santé des animaux. Son usage touche 4 000 agents au total. 

SÈVES permet à la fois de :
- décrire les évènements sanitaires
- de partager les informations nécessaires à leur gestion,
- et de tracer les décisions prises et les actions engagées.
